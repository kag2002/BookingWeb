...
export class ChinhSachChungServiceProxy {
   ...
   */
  getPolicyByDVKDId(
    dvkdId: number | undefined
  ): Observable<ChinhSachChungOutoutDto> {
    let url_ =
      this.baseUrl + "/api/services/app/ChinhSachChung/GetPolicyByDVKDId?";
    if (dvkdId === null)
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<ChinhSachChungOutoutDto>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetPolicyByDVKDId(
    response: HttpResponseBase
  ): Observable<ChinhSachChungOutoutDto> {
    const status = response.status;
    const responseBlob =
  ...
  getAllListChinhSach(): Observable<ChinhSachChungOutoutDto[]> {
    let url_ =
      this.baseUrl + "/api/services/app/ChinhSachChung/GetAllListChinhSach";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetAllListChinhSach(
    response: HttpResponseBase
  ): Observable<ChinhSachChungOutoutDto[]> {
    const status = response.status;
    const responseBlob =
...
export class DichVuTienIchChungServiceProxy {
  ...
  getAllListDichVuChung(): Observable<DichVuChungOutputDto[]> {
    let url_ =
      this.baseUrl +
      "/api/services/app/DichVuTienIchChung/GetAllListDichVuChung";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetAllListDichVuChung(
    response: HttpResponseBase
  ): Observable<DichVuChungOutputDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
...
export class HinhThucPhongServiceProxy {
  ...
  protected processGetRoomByForm(
    response: HttpResponseBase
  ): Observable<PhongSearchinhFilterDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
...
export class LienHeServiceProxy {
  ...
  protected processGetDanhSachLienHe(
    response: HttpResponseBase
  ): Observable<DanhSachOutputDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
   ...
   * @return Success
   */
  getDanhSachLienHeByUserId(
    userId: number | undefined
  ): Observable<DanhSachOutputDto[]> {
    let url_ =
      this.baseUrl + "/api/services/app/LienHe/GetDanhSachLienHeByUserId?";
    if (userId === null)
  ...
  protected processGetDanhSachLienHeByUserId(
    response: HttpResponseBase
  ): Observable<DanhSachOutputDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  protected processClientSendToMessage(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
...
export class LstTrangThaiPhongServiceProxy {
  ...
  getAllLstTrangThaiPhong(): Observable<TrangThaiPhongDto[]> {
    let url_ =
      this.baseUrl +
      "/api/services/app/LstTrangThaiPhong/GetAllLstTrangThaiPhong";
    url_ = url_.replace(/[?&]$/, "");
  ...
  protected processGetAllLstTrangThaiPhong(
    response: HttpResponseBase
  ): Observable<TrangThaiPhongDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  addNewStatus(body: TrangThaiPhongInputDto | undefined): Observable<boolean> {
    let url_ =
      this.baseUrl + "/api/services/app/LstTrangThaiPhong/AddNewStatus";
    url_ = url_.replace(/[?&]$/, "");
  ...
  deleteStatus(id: number | undefined): Observable<boolean> {
    let url_ =
      this.baseUrl + "/api/services/app/LstTrangThaiPhong/DeleteStatus?";
    if (id === null) throw new Error("The parameter 'id' cannot be null.");
    else if (id !== undefined)
      url_ += "Id=" + encodeURIComponent("" + id) + "&";
    url_ = url_.replace(/[?&]$/, "");
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<GetInfoPhongDto>;
        })
      );
  }
...
export class SearchingFilterServiceProxy {
  ...
  protected processSearchingRoom(
    response: HttpResponseBase
  ): Observable<PhongSearchinhFilterDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  getRoomsByLocationAndFilter(
    body: SearchingFilterRoomInputDto | undefined
  ): Observable<PhongSearchinhFilterDto[]> {
    let url_ =
      this.baseUrl +
...
export class SearchingFilterRoomInputDto
  implements ISearchingFilterRoomInputDto
{
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["danhGiaSao"])) {
        ...
        for (let item of _data["danhGiaSao"]) this.danhGiaSao.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.lst)) {
      data["lst"] = [];
      for (let item of this.lst) data["lst"].push(item.toJSON());
    }
    data["mienPhiHuyPhong"] = this.mienPhiHuyPhong;
    ...
    if (Array.isArray(this.danhGiaSao)) {
      data["danhGiaSao"] = [];
      for (let item of this.danhGiaSao) data["danhGiaSao"].push(item);
    }
    if (Array.isArray(this.hinhThucPhongId)) {
      data["hinhThucPhongId"] = [];
      for (let item of this.hinhThucPhongId) data["hinhThucPhongId"].push(item);
    }
